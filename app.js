...
const articles = [
    ...
    },
    {
        ...
        content: `
            ...
            <p>他们主要在继续扛单和继续加空之间选择，满足：<span class="math-inline">P(w<sup>-</sup>) + P(S<sup>-</sup>) ≈ 1</span>，对应三种情况：</p>
            <ul>
    ...
    },
    {
        ...
        content: `
            ...
            <p>但这并不意味着多头完全没有止盈卖压。多头止盈平仓 <span class="math-inline">T<sup>+</sup></span> 是真实存在的，只是在本文设定的阶段中，由于价格距离目标预期 1600 仍有空间，且趋势刚刚确立，止盈卖压暂时不是主要力量。因此可以近似写成：</p>
            <div class="math-block">
                P(L<sup>+</sup>) + P(w<sup>+</sup>) + P(T<sup>+</sup>) ≈ 1
            </div>
            <p>且在趋势确认初期：</p>
            ...
            <h2>九、 回调发生后的二次推导</h2>
            <p>当回调发生且没有破坏大级别多头趋势（未跌破关键成本区和趋势防守位）时，市场的行为会发生二次演变：</p>
            <p>1. <strong>场外非完全理性资金：</strong> 往往将回调视为低吸上车的良机（即 <span class="math-inline">P(L) ↑</span> 增加）。</p>
            <p>2. <strong>场内非完全理性空头：</strong> 回调强化了侥幸心理，空头选择继续死扛（<span class="math-inline">0 &lt; N(S<sup>-</sup>) &lt; 4990</span>），使得空头的潜在止损买盘被完整保留并延迟至更高的价位。</p>
            <p>3. <strong>场内非完全理性多头：</strong> 多头在回调后认为安全边际提高，行为概率极易从“观望”转化为“逢低加仓”（即 <span class="math-inline">P(L<sup>+</sup>) &gt; P(w<sup>+</sup>)</span>，人数过半数）。</p>
            ...
            <p>只要这一买盘能转化为边际订单的优势，回调后价格重新向上运行并进一步击穿空头止损防守线的概率极高。也就是说：<strong>回调并没有破坏多头结构，反而在行为金融层面为大级别趋势重新提供了燃料。</strong></p>
