...
const articles = [
    ...
    {
        id: 5,
        title: "RU 交割品理论极限下限：以国产 SCR WF 与泰国 RSS3 双锚推导",
        category: "shfe",
        categoryName: "上期所",
        date: "2026-06-08",
        readTime: "10 分钟",
        ...
        avatar: "ZL",
        content: `
            <p><strong>前言：</strong> 本文讨论的不是天然橡胶行业平均成本，也不是胶农家庭自割收入，也不是单纯海外主产地田间成本，而是<strong>能够进入上期所 RU 交割体系的天然橡胶交割品，在极限压缩条件下的原料端成本、可交割极限成本和进口替代约束。</strong></p>
            
            <p>更准确地说，本文追求的是 <strong>RU 可交割品的第一性原理极限下限</strong>，而不是现实贸易商完整进口成本、企业完整会计成本、行业平均成本或市场均衡价格。因此，本文有意最少引入不可控外部变量，对海运、港杂、报关、仓储、融资、企业管理、贸易利润等项目仅作弱化处理或边界说明。这些项目会影响现实成交价格和仓单形成成本，但不构成本文推导“物理与制度极限下限”的核心变量。</p>
            
            <p>RU 国产交割标准品是国产天然橡胶 SCR WF，质量符合 GB/T 8081-2018，并实行注册品牌交割；包装要求为每包净含量 33.3kg、每吨 30 包，交割单位为 10 吨。RU 同时允许进口 RSS3 作为交割品。因此，RU 交割的不是田间胶水，而是经过加工、质检、包装、入库后可形成标准仓单的标准化橡胶成品。</p>
            
            <p>RU 盘面极限成本锚不能直接等同于胶水价格，而是可以从两个可交割维度分别倒推：</p>
            <blockquote>
                <strong>国产 SCR WF 链条：</strong> 胶树 → 割胶 → 鲜胶乳 → 收胶 → 胶站/制胶厂 → SCR WF 全乳胶 → 注册品牌 → 质检包装 → 指定交割仓库 → 标准仓单 → RU 交割<br>
                <strong>进口泰国 RSS3 链条：</strong> 胶树 → 割胶 → 鲜胶乳 → 凝固 → 压片/轧片 → USS 未烟片 → 烟熏干燥 → RSS3 分级 → 打包 → FOB 出口 → 中国进口税费 → 指定交割仓库 → 标准仓单 → RU 交割
            </blockquote>
            
            <p>本文的核心问题是：在同一套第一性原理递推逻辑下，一吨能够进入 RU 交割体系的国产 SCR WF 与进口泰国 RSS3，其原料端人工、鲜胶乳折干、组织方式、加工标准化和进口税费约束分别是多少；最终 RU 盘面极端下限应如何由国产可交割成本与进口 RSS3 可交割成本共同锚定？</p>

            <h2>一、 RU 成本锚为什么必须同时看国产 SCR WF 与进口 RSS3</h2>
            <p>RU 可交割品包括国产 SCR WF 和进口 RSS3。其中国产 SCR WF 对应中国境内可交割生产链条（胶园 → 割胶 → 鲜胶乳 → 全乳胶加工 → 质检入库 → 标准仓单），而进口 RSS3 对应进口可交割替代链条（海外胶园 → 割胶 → USS/RSS 加工 → 出口 → 中国进口 → 入库交割）。</p>
            <p>因此，RU 的极端成本锚不能只看单侧，而应写为：</p>
            <blockquote>
                <code>RU 盘面极端下限 = min(国产 SCR WF 可交割极限成本, 进口 RSS3 可交割极限成本) + 仓单库存、资金结构与交割约束修正</code>
            </blockquote>
            <p>国产 SCR WF 成本锚用于判断 RU 对国产可交割品是否进入极端低估区；进口 RSS3 成本锚用于判断海外可交割替代是否能进一步压低 RU 绝对成本底。</p>

            <h2>二、 进口 RSS3 为什么以泰国为主基准</h2>
            <p>进口 RSS3 的主原厂国应优先选泰国。原因在于：泰国是全球天然橡胶最核心生产国之一，且传统上是 USS/RSS 的核心生产地，泰国 RSS3 是进口 RSS3 成本锚中最具有代表性的来源，其小农、分成制、USS/RSS 简单加工和出口贸易体系相对成熟。因此本文进口 RSS3 成本锚采用“泰国 RSS3 可进口成本锚”，这与国产 SCR WF 寻找真正可能进入 RU 交割体系的成本逻辑相符。</p>

            <h2>三、 两个维度的共同递推逻辑</h2>
            <p>国产 SCR WF 与进口泰国 RSS3 的共同核心是：<strong>鲜胶乳折干 + 割胶人工 + 单株单刀胶水量 + 组织方式 + 最低必要加工 + 交割可用性</strong>。</p>
            <p>区别在于：国产 SCR WF 的关键约束是中国境内胶园、人工、承包、全乳胶加工和注册品牌体系；而进口泰国 RSS3 的关键约束是泰国小农低现金流、最低工资、分成制边际供应、USS/RSS 简单加工和中国进口税费。</p>

            <h2>四、 鲜胶乳折干是共同底层逻辑</h2>
            <p>鲜胶乳不是纯橡胶，而是含有大量水分的胶乳。真正进入成品橡胶价值核心的是其中的干胶含量（DRC = Dry Rubber Content）。鲜胶乳折算为干胶的公式为：<code>鲜胶乳折干成本 = 鲜胶乳价格 ÷ DRC</code>。</p>
            <p>若 DRC 为 32%，则 1 吨干胶约需要 3.125 吨鲜胶乳（1 ÷ 32%）；若 DRC 为 36%，则 1 吨干胶约需要 2.778 吨鲜胶乳（1 ÷ 36%）。做极限下限时，不能随意采用过高 DRC。本文采用 <strong>DRC = 36%</strong> 作为偏激进但仍可讨论的严肃极限参数。</p>

            <h2>五、 单株单刀胶水量：年产干胶倒推的校验</h2>
            <p>单株单刀胶水量受树龄、品种、割制、季节、管理等影响，从第一性原理上，长期年产干胶可以拆为：<code>年产干胶 = 有效割株数 × 年有效割刀数 × 单株单刀干胶量</code>。由此可以反推：<code>单株单刀鲜胶乳量 = 年产干胶 ÷ 有效割株数 ÷ 年有效割刀数 ÷ DRC</code>。此方法作为全园长期平均产能校验，能避免把高产树位当成常态。</p>
            <ul>
                <li><strong>国产 SCR WF 参数校验：</strong> 从年产干胶口径反推，中国胶园常见单株单刀胶水量在主模型树位下约为 <code>0.10–0.12 kg/株/刀</code>；在高产/旺产压力测试下约为 <code>0.12–0.15 kg/株/刀</code>。</li>
                <li><strong>泰国 RSS3 参数校验：</strong> 泰国橡胶全国平均产量约为 235 kg/rai/year，以有效株数 70–76 株/rai、年有效割刀数 120–150 刀/年、DRC 36% 计算，反推单株单刀鲜胶乳量约为 <code>0.056–0.078 kg/株/刀</code>。因此，泰国 RSS3 主模型单株单刀胶水量取 <code>0.06–0.08 kg/株/刀</code>；高产压力测试取 <code>0.08–0.10 kg/株/刀</code>。</li>
            </ul>

            <h2>六、 割胶人工是底层硬约束</h2>
            <p>割胶效率受两类硬约束：第一是动作时间约束（割胶、放置收胶器、转移等动作需要固定时间）；第二是生理时间窗口约束（胶树在夜间、凌晨、清晨流胶效果最好，白天温度升高后蒸腾强且胶乳易凝固）。</p>
            <p>在极限熟练胶工假设下，割胶窗口约 5-6 小时，动作约 30-35 秒/棵，效率折扣 90%，单人单日可割约 494–594 棵树：</p>
            <ul>
                <li><strong>国产 SCR WF 单日胶水量：</strong> 按主模型单株单刀胶水量 0.10–0.12 kg 算，单人单日胶水量约 49–71 kg。因此，国产模型取严肃极限胶水量 <code>70 kg/天</code>，激进压力测试取 <code>80-90 kg/天</code>。</li>
                <li><strong>泰国 RSS3 单日胶水量：</strong> 若一个熟练胶工一天割 500–600 株，按主模型单株单刀胶水量 0.06–0.08 kg 计算，单人单日胶水量约 <code>30–48 kg/天</code>；高产压力测试下可达 <code>60–70 kg/天</code>。</li>
            </ul>

            <h2>七、 割胶动作人工折干成本</h2>
            <p>计算公式为：<code>割胶动作人工折干成本 = 日工资 ÷ 单日胶水量 ÷ DRC</code></p>
            <ul>
                <li><strong>国产 SCR WF：</strong> 日收入按 155 元/天，DRC 按 36% 计。若单日胶水量为 70kg、80kg、90kg，折干人工成本分别约为 6151 元/吨、5382 元/吨、4784 元/吨。因此国产割胶人工物理压力测试区间为 <code>4800–6200 元/吨</code>。</li>
                <li><strong>泰国 RSS3：</strong> 最低工资按 337 泰铢/天（约合 69.6 元人民币/天），DRC 按 36% 计。若单日胶水为 30kg、40kg、50kg、60kg，折干人工成本分别约为 6440 元/吨、4840 元/吨、3860 元/吨、3220 元/吨。因此泰国割胶人工物理测试区间为 <code>3200–6400 元/吨</code>，主模型放在 <code>3800–4800 元/吨</code>。</li>
            </ul>

            <h2>八、 国产 SCR WF：承包制下的原胶经营极限成本</h2>
            <p>国产全乳胶主要在承包制下运作（承包树位、计件激励、统一收胶加工）。承包户/胶工分成比例（α）通常在 50%–70% 之间：</p>
            <blockquote>
                <code>承包劳动端折干成本 = 日收入 ÷ 单日胶水量 ÷ α ÷ DRC</code>
            </blockquote>
            <p>计算表明，加上承包户自担的工具、收胶及运输现金支出，原胶经营现金下限大致为：激进低成本口径（α=70%）约为 <code>8500–10500 元/吨</code>；主模型口径（α=60%）约为 <code>9500–11500 元/吨</code>；保守口径（α=50%）约为 <code>11000–13500 元/吨</code>。</p>

            <h2>九、 国产 SCR WF：企业端组织成本</h2>
            <p>即使企业端成本受政府补贴或产业资金支持而弱化，仍需要最小组织成本来保证收胶、控制质量并注册仓单。我们将企业端最低必要组织净成本设为 <code>500–2000 元/吨</code> 的加项。得到国产 SCR WF 原材料成本区间：激进低成本口径为 <code>9000–12000 元/吨</code>；主模型口径为 <code>10000–13500 元/吨</code>（本文主锚）；保守口径为 <code>12000–16000 元/吨</code>。</p>

            <h2>十、 国产 SCR WF：从原材料到可交割极限成本</h2>
            <p>从鲜胶乳折干原料到可交割的 SCR WF 仓单，还需要制胶加工、包装、质检、仓单注册等最低标准化成本（按 <code>500–1500 元/吨</code> 估算）。</p>
            <ul>
                <li><strong>激进低成本口径：</strong> 9000–12000 + 500–1000 = <code>约 9500–13000 元/吨</code></li>
                <li><strong>主模型口径：</strong> 10000–13500 + 500–1500 = <code>约 10500–15000 元/吨</code></li>
                <li><strong>更严肃的盘面极端下限主锚：</strong> <code>约 11000–14500 元/吨</code></li>
            </ul>

            <h2>十一、 进口泰国 RSS3：小农自割低现金流成本</h2>
            <p>泰国约 90% 天然橡胶来自小农，依靠家庭劳动力割胶。在低价时期小农会忽略初始投资和家庭劳动机会成本，这构成了泰国 RSS3 的核心低成本底锚：</p>
            <ul>
                <li><strong>小农低现金流 FOB 成本：</strong> 约 50–57 泰铢/kg，折人民币 <code>10300–11800 元/吨</code>。</li>
                <li><strong>小农最低工资 FOB 成本：</strong> 将家庭劳动按最低工资计入，FOB 约 58–62 泰铢/kg，折人民币 <code>12000–12800 元/吨</code>。</li>
            </ul>

            <h2>十二、 进口泰国 RSS3：分成制边际供应锚</h2>
            <p>泰国中大型持有者采用雇工分成制，工人分成比例（α）约在 40%–60% 之间。分成制折干原料成本加上业主端维护和 FOB 出口费后，其 FOB 边际成本在主模型口径下约为 55–65 泰铢/kg，折人民币 <code>11400–13400 元/吨</code>。它不是最低底，但决定了低价下雇工型供给是否收缩。</p>

            <h2>十三、 进口泰国 RSS3：从 USS 到 RSS3 的加工增量</h2>
            <p>RSS3 加工（USS 未烟片烟熏、分级、打包）技术简单，从 farm gate / USS 到 FOB 的低成本增量约为 8–12 泰铢/kg，折人民币 <code>1650–2500 元/吨</code>。不宜盲目高估此项，以免虚高进口成本。</p>

            <h2>十四、 进口泰国 RSS3 FOB 成本汇总</h2>
            <ul>
                <li><strong>小农低现金流极限口径：</strong> FOB <code>约 10300–11800 元/吨</code>（家庭劳动非完全工资化，极限低价继续供应）。</li>
                <li><strong>小农最低工资口径：</strong> FOB <code>约 12000–12800 元/吨</code>（家庭劳动按最低工资完整计入）。</li>
                <li><strong>分成制边际供应口径：</strong> FOB <code>约 12400–14500 元/吨</code>（分成制边际成本，低价下控制供给收缩）。</li>
            </ul>

            <h2>十五、 进口到中国后的关税与税费</h2>
            <p>中国天然橡胶烟胶片进口适用从量税（1500 元/吨）或从价税（20%）从低计征。在本文推导的成本区间下，从量税更低，故采用 <strong>关税 = 1500 元/吨</strong>。增值税率按 13% 处理，这属于垫资和票据流转约束，不作为永久经济成本计入物理原料成本锚。因此，进口 RSS3 经济成本 = FOB 成本 + 1500 元/吨。</p>

            <h2>十六、 泰国 RSS3 进口到货经济成本与现金流成本</h2>
            <ul>
                <li><strong>小农低现金流口径：</strong> 经济成本 <code>11800–13300 元/吨</code>（含税现金流成本 13300–15000 元/吨）。</li>
                <li><strong>小农最低工资口径：</strong> 经济成本 <code>13500–14300 元/吨</code>（含税现金流成本 15300–16200 元/吨）。</li>
                <li><strong>分成制边际口径：</strong> 经济成本 <code>13900–16000 元/吨</code>（含税现金流成本 15700–18100 元/吨）。</li>
            </ul>

            <h2>十七、 最终定价分层与交易含义</h2>
            <p>我们将 RU 合约的价格底线划分为以下几个核心层级：</p>
            <ol>
                <li><strong>国产原胶经营现金下限：</strong> <code>9500–11500 元/吨</code>，是国产原料端最核心的物理生存边界。</li>
                <li><strong>国产 SCR WF 可交割极限成本：</strong> 主模型口径 <code>10500–15000 元/吨</code>，更严肃的盘面极端下限主锚为 <code>11000–14500 元/吨</code>。</li>
                <li><strong>泰国 RSS3 进口极限经济成本：</strong> 小农自割低现金流极限下为 <code>11800–13300 元/吨</code>；小农完整最低工资下为 <code>13500–14300 元/吨</code>；分成制边际为 <code>13900–16000 元/吨</code>。</li>
            </ol>
            <p><strong>最终结论：</strong> RU 盘面极端下限应写成：<code>RU 盘面极端下限 = min(国产 SCR WF 可交割极限成本, 泰国 RSS3 可进口极限成本)</code>，并结合仓单库存与资金结构修正。</p>
            <p>当 RU 盘面跌入 <strong>11000–14500 元/吨</strong> 附近，意味着价格已经深度压入国产 SCR WF 与进口泰国 RSS3 的共同极限成本区，安全边际极高。如果进一步跌破，则需要观察泰国小农自割低现金流极限的耐受性、关税增值税垫资承受力以及国内仓单库存和需求塌陷状况。</p>
        `
    },
];
