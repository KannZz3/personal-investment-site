...
const articles = [
    ...
    },
    {
        ...
        content: `
            ...
            <p>更准确地说，本文追求的是 <strong>RU 可交割品的第一性原理极限下限</strong>，而不是现实贸易商完整进口成本、企业完整会计成本、行业平均成本或市场均衡价格。因此，本文有意最少引入不可控外部变量，对海运、港杂、报关、仓储、融资、企业管理、贸易利润、政策补贴差异等项目仅作弱化处理或边界说明。这些项目会影响现实成交价格和仓单形成成本，但不构成本文推导“物理与制度极限下限”的核心变量。</p>
            ...
            <p>RU 盘面极限成本锚不能直接等同于胶水价格，也不能直接等同于单个割胶工工资，而应从两个可交割维度分别倒推：</p>
            <blockquote>
            ...
            <p>本文的核心问题是：在同一套第一性原理递推逻辑下，一吨能够进入 RU 交割体系的国产 SCR WF 与进口泰国 RSS3，其原料端人工、鲜胶乳折干、组织方式、最低加工、进口税费和交割资格约束分别是多少；最终 RU 盘面极端下限应如何由国产可交割成本与进口 RSS3 可交割成本共同锚定？</p>

            <h2>一、 为什么 RU 成本锚必须同时看国产 SCR WF 与进口 RSS3</h2>
            <p>RU 可交割品包括国产 SCR WF 和进口 RSS3。</p>
            <p>国产 SCR WF 对应的是中国境内可交割生产链条（胶园 → 割胶 → 鲜胶乳 → 全乳胶加工 → 质检入库 → 标准仓单）。进口 RSS3 对应的是进口可交割替代链条（海外胶园 → 割胶 → USS / RSS 加工 → 出口 → 中国进口 → 入库交割）。</p>
            <p>因此，RU 的极端成本锚不能只看国产 SCR WF，也不能只看海外主产地田间成本，而应写成：</p>
            <blockquote>
            ...
            <h2>二、 为什么国产 SCR WF 不能单独代表 RU 绝对底</h2>
            <p>中国天然橡胶需求高度依赖进口，近年进口占比大致在 85%–90%，国产供应占比约 10%–15%。同时，中国天然橡胶产量约占全球天然橡胶产量的 5%–6%。</p>
            <p>因此，国产 SCR WF 成本锚适合用于判断 RU 对国产可交割品的极端低估区，但不能单独代表全球天然橡胶绝对成本底。</p>
            <p>更完整的 RU 盘面极端下限应看国产 SCR WF 可交割极限成本与进口 RSS3 可交割极限成本，二者谁更低、谁能真实形成仓单、谁在交割月具备边际供给能力。</p>
            <p>因此，国产 SCR WF 成本锚不是错，而是国产交割品一侧的成本底；若进口 RSS3 可以形成更低的可交割供给，RU 的绝对下限仍可能被进口成本锚压低。</p>

            <h2>三、 进口 RSS3 在 RU 交割中的理论占比</h2>
            <p>规则上，进口 RSS3 在 RU 总交割量中的占比没有明确上限。只要卖方持有符合交割要求的有效标准仓单，进口 RSS3 可以与国产 SCR WF 一样用于 RU 交割。因此，进口 RSS3 在某一交割月理论上可以占 RU 交割量的 0%–100%。</p>
            <p>但现实占比取决于：进口 RSS3 是否有足够标准仓单、是否在报关/入库和有效期要求内、是否按期进入上期所指定交割仓库、进口成本是否低于国产 SCR WF 成本，以及当期仓单库存结构和交割月持仓结构。</p>
            <p>因此，RU 盘面不能只看国产 SCR WF 成本。即使国产 SCR WF 成本较高，只要进口 RSS3 可以形成更低的可交割供给， RU 的绝对下限仍会受到进口成本锚约束。</p>

            <h2>四、 海外主产地极限成本与 RU 可交割成本的边界</h2>
            <p>中国天然橡胶生产成本明显偏高。海南、云南受人工、季节、单产、土地和胶园维护约束较强，现实调研中的自产干胶成本明显高于海外主产区。海外主产地包括泰国、越南、印尼、科特迪瓦等。若只看主产地田间到干胶的极限现金成本，低成本区可能在 <code>约 7000–10000 元/吨干胶</code>；若加入胶园可持续维护和初级加工，较严肃的海外主产地成本大致在 <code>约 9000–12000 元/吨干胶</code>。</p>
            <p>若形成海外可出口标准胶，还需要加入初级加工、分级、包装、内陆运输、出口商利润、港口费用和融资成本，成本大致上移至 <code>约 9500–12500 元/吨</code>。</p>
            <p>但 RU 不能直接采用“海外最低田间成本”作为盘面下限。原因是 RU 的进口可交割品是 RSS3，而不是任意海外杯胶、TSR、低等级标胶或非洲低成本标准胶。因此，海外主产地成本只是进口 RSS3 成本的底层原料约束。真正能约束 RU 交割的，是：<strong>海外 RSS3 生产 / 出口成本 + 汇率 + 进口税费 + 交割资格 + 标准仓单形成能力</strong>。</p>

            <h2>五、 进口 RSS3 为什么以泰国为主基准</h2>
            <p>进口 RSS3 的主原厂国应优先选泰国。原因不是泰国所有天然橡胶都最低成本，而是：泰国是全球天然橡胶最核心生产国之一；传统上是 USS / RSS 的核心生产国；泰国 RSS3 是进口 RSS3 成本锚中最具有代表性的来源；且泰国小农、分成制、USS/RSS 简单加工和出口贸易体系相对成熟。因此，本文进口 RSS3 不采用“海外泛主产地成本”，而采用“泰国 RSS3 可进口成本锚”，寻找真正可能进入 RU 交割体系的可交割品成本。</p>

            <h2>六、 两个维度的共同递推逻辑</h2>
            <p>国产 SCR WF 与进口泰国 RSS3 的共同核心是：<strong>鲜胶乳折干 + 割胶人工 + 单株单刀胶水量 + 组织方式 + 最低必要加工 + 税费制度 + 交割可用性</strong>。</p>
            <p>区别在于：国产 SCR WF 的关键约束是中国境内胶园、人工、承包、全乳胶加工和注册品牌体系；而进口泰国 RSS3 的关键约束是泰国小农低现金流、最低工资、分成制边际供应、USS/RSS 简单加工、FOB 出口和中国进口税费。</p>

            <h2>七、 鲜胶乳折干是共同底层逻辑</h2>
            <p>鲜胶乳不是纯橡胶，而是含有大量水分 of 胶乳。真正进入成品橡胶价值核心的是其中的干胶含量（DRC = Dry Rubber Content）。鲜胶乳折算为干胶的公式为：<code>鲜胶乳折干成本 = 鲜胶乳价格 ÷ DRC</code>。</p>
            <p>若 DRC 为 32%，则 1 吨干胶约需要 3.125 吨鲜胶乳；若 DRC 为 36%，则 1 吨干胶约需要 2.778 吨鲜胶乳。做极限下限时，不能随意采用过高 DRC。本文采用 <strong>DRC = 36%</strong> 作为偏激进但仍可讨论的严肃极限参数。</p>

            <h2>八、 单株单刀胶水量：年产干胶倒推只能作为一致性校验</h2>
            <p>单株单刀胶水量受树龄、品种、树势、割制、季节、天气和管理等影响，从第一性原理上，长期年产干胶可以拆成：<code>年产干胶 = 有效割株数 × 年有效割刀数 × 单株单刀干胶量</code>。由此可以反推：<code>单株单刀鲜胶乳量 = 年产干胶 ÷ 有效割株数 ÷ 年有效割刀数 ÷ DRC</code>。注意，此方法是全园长期平均产能校验，能避免把高产树位当成常态。</p>
            <p>若单株年产干胶为 1.5kg，按 60–90 刀/年、DRC 32%–36% 反推，鲜胶乳量约为 0.05–0.08kg/株/刀；若单株年产干胶为 2.8kg，反推结果约为 0.09–0.15kg/株/刀；若为 3.5kg，反推结果为 0.11–0.18kg/株/刀。</p>
            <ul>
                <li><strong>低产/保守树位：</strong> 0.08–0.10 kg/株/刀</li>
                <li><strong>主模型树位：</strong> 0.10–0.12 kg/株/刀（本文采用）</li>
                <li><strong>高产/旺产压力测试：</strong> 0.12–0.15 kg/株/刀（本文高产压力测试采用）</li>
            </ul>

            <h2>九、 泰国 RSS3 的单株单刀参数校验</h2>
            <p>泰国橡胶平均产量采用全国平均 235 kg/rai/year，南部主产区 254 kg/rai/year。以有效株数 70–76 株/rai、年有效割刀数 120–150 刀/年、DRC 36% 计算：</p>
            <ul>
                <li>单株年干胶量：235 ÷ 70–76 ≈ <code>3.1–3.4 kg/株/年</code></li>
                <li>单株单刀干胶量：3.1–3.4 ÷ 120–150 ≈ <code>20–28 g/株/刀</code></li>
                <li>单株单刀鲜胶乳量：20–28g ÷ 36% ≈ <code>0.056–0.078 kg/株/刀</code></li>
            </ul>
            <p>以南部产区计，单株单刀鲜胶乳量约为 0.060–0.084 kg/株/刀。因此，泰国 RSS3 主模型单株单刀胶水量取 <code>0.06–0.08 kg/株/刀</code>；高产压力测试取 <code>0.08–0.10 kg/株/刀</code>。</p>
            <p>注意：本文用 120–150 刀/年做单株单刀产胶量校验，用 300 天/年只用于泰国小农模型的工资年化，不把两者混用。</p>

            <h2>十、 割胶人工是底层硬约束，但不能单独代表盘面底</h2>
            <p>割胶效率受两类硬约束：第一是动作时间约束（割胶、放置收胶器、转移等动作需要固定动作时间）；第二是生理时间窗口约束（胶树在夜间、凌晨、清晨更容易流胶，白天温度升高后蒸腾强且胶乳容易凝固）。</p>
            <p>在极限熟练胶工假设下，割胶窗口约 5-6 小时，动作约 30-35 秒/棵，效率折扣 90%，单人单日可割约 <strong>494–594 棵</strong>。</p>

            <h2>十一、 国产 SCR WF 单日胶水量</h2>
            <p>若按主模型单株单刀胶水量 0.10–0.12 kg，单人单日胶水量约 <code>49–71 kg</code>。若采用高产树位压力测试下偏乐观假设（0.12–0.15 kg），可达到 <code>59–89 kg</code>。</p>
            <p>本文国产模型取：严肃极限胶水量 <code>70 kg/天</code>；激进压力测试 <code>80 kg/天</code>；极端高产压力测试 <code>90 kg/天</code>。</p>

            <h2>十二、 泰国 RSS3 单日胶水量</h2>
            <p>泰国不能用年干胶简单除以 300 天直接作为有效割胶日单人产胶量，应从当天实际割株数 × 单株单刀胶水量来推。若熟练胶工割 500–600 株，主模型单株单刀胶水量为 0.06–0.08 kg，则单日胶水约为 <code>30–48 kg/天</code>；若采用更好树位或更强劳动可达 <code>60–70 kg/天</code>。</p>
            <p>因此，泰国单人单日胶水量分层为：保守/平均口径 <code>30–45 kg/天</code>；主模型口径 <code>40–60 kg/天</code>；高产压力测试 <code>60–70 kg/天</code>。</p>

            <h2>十三、 割胶可以加速，但不能无限外推为大规模低成本供应</h2>
            <p>割胶动作本身确实存在加速空间，但效率上限不仅由人决定，还由可割树况和路径等经营条件决定。小型民企受限于胶树数量少、分散、树况不均及缺乏进入标准交割体系的质控能力，很难代表大规模的边际供应。</p>
            <p>大型企业或农垦企业虽然有足够胶树规模和加工能力，但通常通过承包树位、产量计件、分成和统一收胶等组织方式控制供应节奏，以保障长期胶树寿命和交割品质。因此，RU 极端下限模型不能只采用“最快割胶速度 × 最低工资”，而必须同时满足：<strong>极限熟练胶工效率 × 足够胶树规模 × 企业承包组织 × 可持续割制约束 × SCR WF 交割质量约束</strong>。</p>

            <h2>十四、 割胶动作人工折干成本</h2>
            <p>计算公式为：<code>割胶动作人工折干成本 = 日工资 ÷ 单日胶水量 ÷ DRC</code></p>
            <ul>
                <li><strong>国产 SCR WF：</strong> 日收入 155 元/天，DRC 36%。若单日胶水为 70kg、80kg、90kg，折干人工成本分别约为 6151 元/吨、5382 元/吨、4784 元/吨。国产割胶动作人工物理测试区间为 <code>约 4800–6200 元/吨</code>。</li>
                <li><strong>泰国 RSS3：</strong> 最低工资 337 泰铢/天（约合 69.6 元人民币/天），DRC 36%。单日胶水量 30kg、40kg、50kg、60kg 时，折干人工约为 6440 元/吨、4840 元/吨、3860 元/吨、3220 元/吨。物理测试区间为 <code>约 3200–6400 元/吨</code>，主模型放在 <code>约 3800–4800 元/吨</code>。</li>
            </ul>
            <p>注意，割胶动作人工不能单独代表盘面底，它只包含底层收割动作，不含胶园、加工、税费等环节。</p>

            <h2>十五、 割胶工人工资是国产 SCR WF 成本推导的核心硬约束</h2>
            <p>企业端或胶园层面的成本可能受各类政府补贴或保险等摊薄弱化，但割胶工人工资直接受劳动力机会成本和极高的夜间劳动强度约束，无法被补贴穿透。因此，在极限下限模型中，人工工资是刚性约束。更接近真实的“种植端人工硬底”应包括：<strong>割胶人工 + 胶园抚管人工 + 收胶搬运人工 + 承包分成人工收益</strong>。</p>

            <h2>十六、 为什么不能采用纯日结人工模型作为国产 SCR WF 主锚</h2>
            <p>RU 盘面需要的是可交割的 SCR WF，而不是零散的胶水。大型交割品牌企业均通过承包、计件及统一收胶加工的机制运作。因此，下限主锚不能采用单点日结模型，而应采用：<strong>可进入交割体系的原料端人工极限成本 + 必要组织成本</strong>。企业端土地、胶园资产、管理等受政策和保险缓冲较强的项目可以作为弱化项处理。</p>

            <h2>十七、 国产 SCR WF：承包制下的原胶经营极限成本</h2>
            <p>承包户/胶工分成比例（α）取值通常在 50%–70% 之间（70% 为激进低成本，60% 为主模型，50% 为保守）：</p>
            <blockquote>
                <code>承包劳动端折干成本 = 日收入 ÷ 单日胶水量 ÷ α ÷ DRC</code>
            </blockquote>
            <p>代入日收入 155 元，单日胶水 70–90 kg，DRC 36% 测算：α = 70% 对应约 6800–8800 元/吨；α = 60% 对应约 8000–10300 元/吨；α = 50% 对应约 9600–12300 元/吨。加上承包户自担的收胶工具、运输等现金支出，国产原胶经营现金下限为：</p>
            <ul>
                <li>激进低成本口径 (α = 70%)：<code>约 8500–10500 元/吨</code></li>
                <li>主模型口径 (α = 60%)：<code>约 9500–11500 元/吨</code>（本文采用）</li>
                <li>保守口径 (α = 50%)：<code>约 11000–13500 元/吨</code></li>
            </ul>

            <h2>十八、 国产 SCR WF：企业端成本应弱化处理，但不能归零</h2>
            <p>企业端面临的折旧、林地机会成本、管理费等可以受政府项目和产业资金缓冲而被弱化，但必须保留最小的组织成本以保证原料收集和仓单注册。我们将企业端最低必要组织净成本设为 <code>500–2000 元/吨</code> 的弱化加项：</p>
            <ul>
                <li>激进低成本口径：<code>约 9000–12000 元/吨</code></li>
                <li>主模型口径：<code>约 10000–13500 元/吨</code>（本文主锚）</li>
                <li>保守口径：<code>约 12000–16000 元/吨</code></li>
            </ul>

            <h2>十九、 国产 SCR WF：从原材料下限到可交割极限成本</h2>
            <p>加入加工、干燥、包装、质检、注册品牌管理、入库及仓单注册等最低必要交割标准化增量（按 <code>500–1500 元/吨</code> 估算）：</p>
            <ul>
                <li>激进低成本口径：9000–12000 + 500–1000 ≈ <code>9500–13000 元/吨</code></li>
                <li>主模型口径：10000–13500 + 500–1500 ≈ <code>10500–15000 元/吨</code></li>
                <li>更严肃的盘面极端下限主锚：<code>11000–14500 元/吨</code></li>
            </ul>

            <h2>二十、 现实调研数据对国产模型的约束</h2>
            <p>海南、云南的调研数据为模型提供了产业常识底线约束，防止模型参数脱离现实：海南全乳胶直接生产成本通常在 1.6 万元/吨以上；云南自产干胶综合成本约 1.5 万元/吨；民营胶园割工收入约 5000–8000 元/月。这些数据表明，单纯动作人工远低于经营成本，且价格长期过低时，供应端会通过弃割、弃种、招工困难等方式主动修正产能。</p>

            <h2>二十一、 进口泰国 RSS3：小农低现金流是核心低成本锚</h2>
            <p>泰国约 90% 天然橡胶由小农家庭经营，低价期小农会忽略初始投资和家庭劳动机会成本。基于最低工资 337 泰铢/天（比 310 泰铢/天新增 3.45 泰铢/kg 劳动成本）计算，小农自割 FOB 成本为：</p>
            <ul>
                <li><strong>小农低现金流 FOB 成本：</strong> 约 50–57 泰铢/kg，折人民币 <code>10300–11800 元/吨</code>。</li>
                <li><strong>小农最低工资 FOB 成本：</strong> FOB 约 58–62 泰铢/kg，折人民币 <code>12000–12800 元/吨</code>。</li>
            </ul>

            <h2>二十二、 进口泰国 RSS3：分成制是边际供应锚</h2>
            <p>中大型持有者常用雇工分成制（割胶工分成比例 α 取 40%–60%，主模型为 50%）。计算表明，其 FOB 边际成本在主模型口径下约为 55–65 泰铢/kg，折人民币 <code>11400–13400 元/吨</code>。它决定了低价下雇工型供给是否收缩。</p>

            <h2>二十三、 进口泰国 RSS3：从 USS 到 RSS3 的加工增量</h2>
            <p>从 farm gate / USS 到 FOB 的低成本加工增量（凝固、压片、烟熏干燥、打包等）约为 8–12 泰铢/kg，折人民币 <code>1650–2500 元/吨</code>。</p>

            <h2>二十四、 泰国 RSS3 FOB 成本锚</h2>
            <ul>
                <li><strong>小农低现金流极限口径：</strong> FOB <code>约 10300–11800 元/吨</code>（家庭劳动非完全工资化）。</li>
                <li><strong>小农最低工资口径：</strong> FOB <code>约 12000–12800 元/吨</code>（家庭劳动按最低工资完整计入）。</li>
                <li><strong>分成制 / 中大型边际口径：</strong> FOB <code>约 12400–14500 元/吨</code>（分成制边际成本）。</li>
            </ul>

            <h2>二十五、 进口到中国后的税费</h2>
            <p>中国天然橡胶烟胶片适用从量税（1500 元/吨）或从价税（20%）从低计征。在本文推导区间下采用 <strong>关税 = 1500 元/吨</strong>。增值税率 13% 视为资金流垫资和票据流转约束，不作为永久经济成本计入：</p>
            <blockquote>
                <code>进口 RSS3 极限经济成本 ≈ FOB 成本 + 1500 元/吨</code><br>
                <code>进口 RSS3 现金流成本 ≈ (FOB 成本 + 1500) × 1.13</code>
            </blockquote>
            <p>由于盘面对比需注意含税差异，进口 RSS3 应同时观察含税现金流成本区间，但不能将不含税经济成本与含税盘面价格机械等同。</p>

            <h2>二十六、 泰国 RSS3 到中国后的成本区间</h2>
            <ul>
                ...
                <li><strong>分成制 / 中大型边际口径：</strong> 经济成本 <code>13900–16000 元/吨</code>（含税现金流成本 15700–18100 元/吨）。</li>
            </ul>

            <h2>二十七、 泰国 RSS3 模型对 RU 下限的含义</h2>
            <p>小农低现金流决定绝对成本底，分成制决定供应收缩的边际。极限低价时，进口 RSS3 可以成为 RU 绝对下限的重要组成部分，但进入完整工资与分成制约束后，进口 RSS3 相比国产 SCR WF 并无显著的低价优势。本文将海运、报关、国内物流及贸易商利润等作为现实偏离解释，不完整计入极限物理成本锚。</p>

            <h2>二十八、 最终定价分层</h2>
            <ol>
                <li><strong>割胶动作人工物理压力测试：</strong> 国产 SCR WF 约为 <code>4800–6200 元/吨</code>；泰国 RSS3 主模型为 <code>3800–4800 元/吨</code>。</li>
                <li><strong>国产原胶经营现金下限：</strong> 主模型口径 <code>9500–11500 元/吨</code>，是国产原料端生存底线。</li>
                <li><strong>国产 SCR WF 可交割极限成本：</strong> <code>10500–15000 元/吨</code>，更严肃的盘面极端下限主锚为 <code>11000–14500 元/吨</code>。</li>
                <li><strong>泰国 RSS3 可进口极限成本：</strong> 小农低现金流经济成本 <code>11800–13300 元/吨</code>（现金流成本 13300–15000 元/吨）；小农最低工资 <code>13500–14300 元/吨</code>。</li>
                <li><strong>RU 盘面绝对极端下限：</strong> <code>min(国产 SCR WF 可交割极限成本, 泰国 RSS3 可进口极限成本)</code>，并结合仓单库存与资金结构修正。</li>
            </ol>

            <h2>二十九、 最终结论</h2>
            <p>综上，RU 的国产可交割极限成本主模型口径为 <code>约 10500–15000 元/吨</code>，更严肃的盘面极端下限主锚为 <code>约 11000–14500 元/吨</code>。泰国 RSS3 小农低现金流进口经济成本为 <code>约 11800–13300 元/吨</code>，完整最低工资进口经济成本为 <code>约 13500–14300 元/吨</code>。</p>
            <p>当 RU 盘面跌入 <strong>11000–14500 元/吨</strong> 附近，意味着价格已经接近或压入国产 SCR WF 与进口泰国 RSS3 的共同极限成本区，难以长期跌破。短期偏离仍需要通过泰国小农供应弹性、增值税现金流流转、国内仓单库存积压或需求塌陷等外部因素解释。</p>
        `
    },
];
