...
const articles = [
    ...
    {
        id: 5,
        title: "RU 交割品理论下限：以国产 SCR WF 与泰国 RSS3 双锚推导",
        category: "shfe",
        categoryName: "上期所",
        date: "2026-06-08",
        readTime: "10 分钟",
        ...
        content: `
            ...
            <p>泰国小农成本模型中的 300 天/年，更接近经营天数或工资年化假设；<br>
            单树实际割胶频次受割制、季节和轮割影响，不等于每棵树每年割 300 刀。</p>

            <p>因此，本文用 120–150 刀/年做单株单刀产胶量校验，用 300 天/年只用于工资年化，不把两者混用。</p>
            ...
            <p>原因是它只代表“把胶割出来”的动作人工项，没有包含胶园抚管、收胶搬运、承包激励、胶树资产保护、鲜胶乳质量控制、SCR WF 加工、注册品牌、包装质检、入库仓单 and 交割制度。</p>
            ...
            <p>本文在进口 RSS3 侧采用更极限的下限口径：</p>

            <p><strong>前端只保留割胶动作人工折干成本；从原料端到 RSS3 FOB 只保留加工与 FOB 成本；其余小农完整成本项目不进入本文主公式，仅作为现实 FOB 成本上移和长期供应可持续性的校验项。</strong></p>
            ...
            <p>原因是本文不是还原泰国小农长期可持续完整成本，而是寻找：</p>

            <p><strong>在极端低价下，理论上仍可能形成 RSS3 出口货源的最低物理与制度下限。</strong></p>

            <p>这些项目不进入本文主公式，不代表现实中不存在，也不代表长期可以不支付；只是因为不可控、地区差异大、会计口径复杂，且不属于本文“极限下限主锚”，所以不进入主推导。</p>

            <hr>

            <h2>十一、泰国 RSS3：单株单刀胶水量校验</h2>

            <p>泰国 RSS3 单株单刀胶水量不再采用 2016 年旧模型中的 235 kg/rai/year 和 254 kg/rai/year，而改用近三年数据校验。</p>

            <p>近三年泰国橡胶单产可采用：</p>

            <ul>
                <li>2023 年全国平均：214 kg/rai/year</li>
                <li>2023 年南部主产区：216 kg/rai/year</li>
                <li>2024 年全国平均：约 213 kg/rai/year</li>
                <li>2025 年全国 / 南部估计：约 220–221 kg/rai/year</li>
            </ul>
            ...
            <h2>十二、泰国 RSS3：割胶动作人工物理压力测试</h2>

            <p>泰国不能用：</p>

            <p>10 rai × 213–221 kg/rai/year ÷ 300 天<br>
            ≈ 7.1–7.4 kg 干胶/天</p>

            <p>直接作为有效割胶日单人干胶量。</p>

            <p>原因是 10 rai 是一个割胶工负责的经营面积，不等于每天从全园平均产生 1/300 的年干胶。</p>

            <p>真正的有效割胶日产胶量应与中国部分采用同一套割胶效率逻辑，从：</p>
            ...
            <p>但这个数值仍不能单独作为进口 RSS3 成本底。它只是“原料端割胶动作人工”，还没有把鲜胶乳或初级原料变成可出口 RSS3。</p>

            <hr>

            <h2>十三、泰国 RSS3：为什么小农完整成本项目在本文主公式中不进入主公式</h2>

            <p>泰国小农完整成本模型通常包含种植摊销、后续维护、家庭劳动完整工资化、farm gate cost、中间商成本和利润、加工与 FOB 成本。</p>

            <p>但本文目标不是还原完整小农成本，而是构造极限成本下限。</p>

            <p>在极限下限框架中：</p>

            <ol>
                <li>种植与前期维护摊销更接近历史投入和沉没成本，不进入主公式。</li>
                <li>第 8 年后肥料与维护长期存在，但短期可通过减少施肥、延后维护、家庭劳动替代等方式压缩，因此不进入主公式。</li>
                <li>家庭劳动完整机会成本不一定完全工资化，低价时期小农可能只追求现金流，因此完整劳动工资化只作为现实校验。</li>
                <li>中间商利润和贸易环节受地区、数量、融资和交易关系影响较大，为避免引入过多不可控数据，不进入主推导。</li>
                <li>只保留加工与 FOB 成本，因为 RSS3 必须经过凝固、压片、烟熏、分级、打包和出口，才能成为 RU 可交割进口品。</li>
            </ol>

            <p>因此，从原料端到 RSS3 FOB，本文只保留：</p>

            <p>加工与 FOB 成本：约 7.80 泰铢/kg</p>

            <p>这是 RSS3 侧极限下限的核心处理。</p>

            <hr>

            <h2>十四、泰国 RSS3：从原料端到 RSS3 FOB 的极限增量</h2>

            <p>RSS3 不是 TSR 标胶。</p>

            <p>TSR 需要更重的集中化加工、破碎、清洗、干燥、压块和质量控制；RSS3 更接近 USS 未烟片进一步烟熏、分级和打包。</p>
            ...
            <p>进口 RSS3 FOB 极限成本<br>
            ≈ 泰国割胶动作人工折干成本 + RSS3 加工与 FOB 成本</p>

            <hr>

            <h2>十五、泰国 RSS3 FOB 极限成本</h2>

            <p>由于本文在 RSS3 侧只保留割胶动作人工、RSS3 加工与 FOB 成本、中国进口税费，因此该结果必然显著低于完整小农 FOB 成本 and 现实贸易商进口成本。</p>
            ...
            <ul>
                ...
                <li>主模型现金流成本：约 8000–10700 元/吨</li>
            </ul>

            <p>这个区间是极限压缩口径，不是现实贸易商完整成本。现实中只要加入种植维护、完整劳动机会成本、中间商流通、海运、港杂、报关、仓储、资金和利润，该区间会明显上移。</p>

            <hr>

            <h2>双锚合并：RU 盘面极端下限</h2>

            <h2>十八、国产 SCR WF 与进口 RSS3 的成本关系</h2>
            ...
            <p>约 3300–7700 元/吨<br>
            主模型约 4300–6400 元/吨</p>

            <p>含义：</p>

            <p>只代表极限熟练胶工的割胶动作人工项，不能单独作为 RU 盘面下限。</p>
            ...
            <p>覆盖承包户 / 胶工最低收益、分成关系和部分直接经营成本，是国产原料端极限成本的核心下限。</p>

            <hr>

            <h3>3. 国产 SCR WF 可交割极限成本</h3>
            ...
            <p>在企业端成本被政策补贴、项目资金和规模化组织弱化后，国产 SCR WF 可进入交割体系的极限供给成本。</p>

            <hr>

            <h3>4. 泰国 RSS3 可进口极限成本</h3>
            ...
            <p>该口径只保留泰国割胶动作人工、RSS3 加工与 FOB 成本、中国进口税费，不包含小农完整种植维护、完整劳动机会成本、中间商利润、海运、港杂、仓储、资金和贸易利润。</p>

            <hr>

            <h3>5. RU 盘面绝对极端下限</h3>

            <p>RU 盘面绝对极端下限不能只看国产 SCR WF，也不能只看进口 RSS3，而应看：</p>

            <p>min(国产 SCR WF 可交割极限成本，泰国 RSS3 可进口 / 可交割极限成本)</p>
            ...
            <p>这里的“结合”不是把所有外部变量机械加回主成本锚，而是用于解释盘面为什么可能短期偏离极限成本区。</p>

            <hr>

            <h2>二十、现实数据的位置：只做校验，不做推导前提</h2>

            <p>现实产业数据的作用不是替代第一性原理推导，而是校验模型是否脱离产业常识。</p>

            <h3>国产侧校验</h3>

            <p>现实调研中，海南地区天然橡胶直接生产成本被描述为 1.6 万元/吨以上；云南自产干胶综合成本约 1.5 万元/吨；割胶和胶园抚管人工成本约 10000 元/吨；海南民营胶园按一亩胶园年产 60kg、人工工资 150 元/天测算，橡胶种植生产成本约 16300 元/吨。</p>

            <p>这些数据说明：</p>

            <ol>
                <li>单纯割胶动作人工项远低于完整原胶成本。</li>
                <li>企业组织下的胶园生产成本明显高于日结人工下限。</li>
                <li>割胶和胶园抚管人工是国产天然橡胶成本中最刚性的部分。</li>
                <li>分成比例必须作为敏感性参数，而不是固定为 70%。</li>
                <li>当原料胶价格过低时，供应端会通过弃割、弃种、减产、招工困难来修正。</li>
                <li>若单株单刀胶水量取值过高，会系统性低估 RU 国产 SCR WF 的原料成本。</li>
            </ol>

            <p>因此，国产 SCR WF 的现实完整成本高于本文极限下限是正常的。</p>

            <p>本文不是在还原完整会计成本，而是在主动压缩企业端和不可控成本后，寻找可交割供给最难长期跌破的极限区域。</p>

            <h3>泰国侧校验</h3>

            <p>泰国天然橡胶以小农为主，RSS/USS 体系成熟，小农低现金流决定低成本底。</p>

            <p>但本文在 RSS3 侧采用更激进的极限下限口径：</p>

            <ul>
                <li>前端只保留割胶动作人工折干成本</li>
                <li>从原料端到 RSS3 FOB 只保留加工与 FOB 成本</li>
                <li>种植摊销、维护、完整家庭劳动机会成本、中间商利润等全部不进入本文主公式</li>
            </ul>

            <p>因此，本文推导出的泰国 RSS3 极限成本明显低于完整小农 FOB 成本。</p>

            <p>这不代表现实贸易商进口成本真的只有这个水平，而是说明：</p>

            <p><strong>如果只站在物理生产、最低加工和进口税费角度看，泰国 RSS3 的极限理论下限可以远低于国产 SCR WF。</strong></p>

            <p>现实中，一旦加入完整小农成本、维护、流通、海运、港杂、仓储、资金和贸易利润，进口 RSS3 成本会明显上移。</p>

            <p>所以，泰国 RSS3 极限成本锚适合用于判断 RU 的理论极限锚；完整进口成本更适合用于判断现实贸易套利和仓单形成成本。</p>

            <hr>

            <h2>二十一、最终结论</h2>

            <p>RU 国产交割品的可交割极限成本下限，不能用最低割胶动作人工直接代表，也不能用普通胶水价格简单除以 DRC。</p>

            <p>国产 SCR WF 必须从以下链条倒推：</p>
            ...
            <p>进口泰国 RSS3 同样不能用海外现货价格或中国进口报价直接代表，而必须从以下链条递推：</p>
            ...
            <p>在本文极限下限口径中，泰国 RSS3 侧只保留：</p>

            <ul>
                <li>割胶动作人工折干成本</li>
                <li>RSS3 加工与 FOB 成本</li>
                <li>中国进口税费</li>
                <li>增值税现金流口径</li>
            </ul>
            ...
            <p>它衡量的不是价格绝对不能跌破哪里，而是价格跌破后，哪一类可交割供给最先失去持续供应能力。</p>

            <p>短期盘面仍可能因仓单库存、需求塌陷、资金结构、交割月挤压或贸易商被动抛售而跌破该区域。</p>

            <p>如果 RU 盘面接近国产 SCR WF 的 11000–14500 元/吨区间，意味着价格已经压入国产可交割品的极限成本区。</p>
            ...
            <p>中国境内原料端人工、承包制、企业组织和可交割加工成本。</p>

            <p>进口泰国 RSS3：</p>

            <p>泰国短期现金流型原料、RSS3 加工与 FOB 成本、中国进口税费和仓单形成能力。</p>
